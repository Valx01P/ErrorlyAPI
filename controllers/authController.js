    ...
    async githubCallback(req, res) {
        try {
            ...
            if (!primaryEmail) {
                ...
                return res.redirect('https://errorlyfrontend.onrender.com/auth/github/error')
            }
            ...
            return res.redirect(`https://errorlyfrontend.onrender.com/auth/github/success?access_token=${tokens.accessToken}`)
